...
public class RectangleSum{
    ...
    // cal row-wise and column-wise sum
    static void findPrefixSumMatrixCol(int[][] matrix){
        ...
        // traverse vertically to cal column-wise sum
        for(int j = 0; j < c; j++){
            for(int i = 1; i < r; i++){
    ...
    static int findSum3(int[][] matrix, int l1, int r1, int l2, int r2){
        int ans = 0, up = 0, left  = 0, sum = 0, leftUp = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter rectangle boundaies l1, r1, l2, r2");
        int l1 = sc.nextInt();
        int r1 = sc.nextInt();
        int l2 = sc.nextInt();
        int r2 = sc.nextInt();
